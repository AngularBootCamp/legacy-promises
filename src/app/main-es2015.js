...
class StarshipListComponent {
    ...
    constructor(http) {
        ...
        http
            .get('https://swapi.co/api/starships/', { headers: _httpUtils__WEBPACK_IMPORTED_MODULE_1__["jsonRequestHeaders"] })
...
StarshipListComponent.ɵfac = function StarshipListComponent_Factory(t) { return new (t || StarshipListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"])); };
StarshipListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: StarshipListComponent, selectors: [["app-root"]], decls: 4, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function StarshipListComponent_Template(rf, ctx) { if (rf & 1) {
