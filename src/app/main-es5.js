...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppStarshipListTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var StarshipListComponent = // Note that index.html changed to include http
    function StarshipListComponent(http) {
      var _this = this;

      _classCallCheck(this, StarshipListComponent);

      this.starships = []; // If you are using HTTP in this trivial one-shot way, it is
      ...
      .then(function (data) {
        console.log(data); // throw ('broke on purpose');

        return data;
      }).then(function (data) {
        return _this.starships = data.results;
      }).catch(console.error);
    };

    StarshipListComponent.ɵfac = function StarshipListComponent_Factory(t) {
      return new (t || StarshipListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
    };
    ...
    StarshipListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function StarshipListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, StarshipListComponent_li_3_Template, 2, 1, "li", 0);
